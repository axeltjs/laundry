...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 29, 2016 at 07:57 AM
...
('P0003', '1231341341414143123', 'SP001', '2016-02-24', 46000, 0),
...
('SP001', 'CV. Green Nusa Computindo', 'Jl. Padat Karya No. 63', '0541663672'),
...
ALTER TABLE `rincian_pembelian`
  ADD PRIMARY KEY (`no_rincian`), ADD KEY `no_pembelian` (`no_pembelian`), ADD KEY `kd_barang` (`kd_barang`);

--
-- Indexes for table `rincian_transaksi`
--
ALTER TABLE `rincian_transaksi`
  ADD PRIMARY KEY (`id_rincian`), ADD KEY `no_transaksi` (`no_transaksi`), ADD KEY `id_jenis_pakaian` (`id_jenis_pakaian`);
...
ALTER TABLE `tb_login`
  ADD PRIMARY KEY (`username`), ADD KEY `nik` (`nik`);

--
-- Indexes for table `tb_pemakaian`
--
ALTER TABLE `tb_pemakaian`
  ADD PRIMARY KEY (`kd_pengeluaran`), ADD KEY `nik` (`nik`), ADD KEY `kd_barang` (`kd_barang`);

--
-- Indexes for table `tb_pembelian`
--
ALTER TABLE `tb_pembelian`
  ADD PRIMARY KEY (`no_pembelian`), ADD KEY `nik` (`nik`), ADD KEY `id_supplier` (`id_supplier`);
...
ALTER TABLE `tb_tarif`
  ADD PRIMARY KEY (`id_jenis_pakaian`), ADD KEY `id_jenis` (`id_jenis`);

--
-- Indexes for table `tb_transaksi`
--
ALTER TABLE `tb_transaksi`
  ADD PRIMARY KEY (`no_transaksi`), ADD KEY `kd_konsumen` (`kd_konsumen`), ADD KEY `nik` (`nik`);
...
--
ALTER TABLE `rincian_pembelian`
  MODIFY `no_rincian` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=38;
--
-- AUTO_INCREMENT for table `rincian_transaksi`
--
ALTER TABLE `rincian_transaksi`
  MODIFY `id_rincian` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=33;
--
