...
<table class="table">
	...
	<tr>
		...
		<td><a class="btn-success" href="/admin/karyawan/karyawan_edit.php?nik=<?php echo $rs['nik']; ?>">Edit</a> 
			<?php if ($_SESSION['nik'] == $rs['nik']): ?>
				
			<?php else: ?>

			|
			<a class="btn-danger" onclick="return confirm('Yakin ingin menghapus data <?php echo $rs['nm_karyawan']; ?> ?')" href="/admin/karyawan/index.php?aksi=delete&nik=<?php echo $rs['nik']; ?>">Hapus</a>
